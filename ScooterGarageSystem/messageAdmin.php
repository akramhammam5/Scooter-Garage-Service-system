...
<?php
$getMessage = "SELECT  messages.* ,learnersignup.FirstName FROM messages INNER JOIN learnersignup on SenderID=learnersignup.LearnerID  WHERE SenderID = '$receiver' AND ReceiverID = ".$_SESSION['ID']." OR SenderID = ".$_SESSION['ID']." AND ReceiverID = '$receiver' ORDER BY createdAt asc";
...
<form class="form-inline" action="" method = "POST">
	<input type="hidden" name = "SenderID" value = "<?=$_SESSION['ID']?>"/>
