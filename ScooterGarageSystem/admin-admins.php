...
if(isset($_POST['submit'])){ 
    $sql="insert into adminregistration (Username , Password) values('".$_POST["formusername"]."','".$_POST["formuserpassword"]."')";
...
if(isset($_POST['submitEdit'])){ 
	...
	$sql2="UPDATE adminregistration SET Username= '".$_POST['formusereditname']."',Password= '".$_POST["formusereditpassword"]."' WHERE ID='".$_POST['formusereditid']."'";
	$conn2->query($sql2);
    $conn2->close();
}
...
<h1 class="title-page-name">Admins</h1>
</div>
</div>
</div>
</div>
...
//   };
  $(document).on("click", "#user_delete_action", function () {
    ...
    $.ajax({
        type: 'post',
        url: 'ajax-request.php',
        data: {'deleteAdminDetails':true,'Id':Idd},
...
var Id=$(this).data('id');
   ...
   $.ajax({
      type: 'post',
      url: 'ajax-request.php',
      data: {'getAdminDetails':true,'Id':Id},
