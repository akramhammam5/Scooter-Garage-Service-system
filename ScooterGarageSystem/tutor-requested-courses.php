...
if(isset($_POST['submit'])){ 
  ...
  // move_uploaded_file($_FILES["formcoursephoto"]["tmp_name"], $target_file);
    ...
    $sql="insert into requestedcourse (BrandName , BrandModel , BrandPrice , Avalability ,Type) values('".$_POST['formname']."','".$_POST["formbrandmodel"]."','".$_POST["formbrandprice"]."','".$_POST["formavalability"]."','".$_POST["formtype"]."')";
...
<h1 class="title-page-name">Requested Products</h1>
</div>
</div>
</div>
</div>
