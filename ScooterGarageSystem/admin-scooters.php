...
if(isset($_POST['submit'])){ 
  ...
  // move_uploaded_file($_FILES["formcoursephoto"]["tmp_name"], $target_file);
    ...
    $sql="insert into scooters (BrandName , BrandModel , BrandPrice , Avalability , Image) values('".$_POST['formname']."','".$_POST["formbrandmodel"]."','".$_POST["formbrandprice"]."','".$_POST["formavalability"]."','3.jpg')";
...
if(isset($_POST['submitEdit'])){ 
	...
	$sql2="UPDATE scooters SET BrandName= '".$_POST['formusereditname']."',BrandModel= '".$_POST["formeditname"]."',BrandPrice= '".$_POST["formeditprice"]."',Avalability= '".$_POST["formavalability"]."' WHERE BrandID='".$_POST['formusereditid']."'";
	$conn2->query($sql2);
    $conn2->close();
}
...
<label class="form-label" for="formname">Brand Name</label>
</div>
</div>
<div class="col-lg-4 col-md-4">
<div class="form-outline mb-4">
<input type="text" class="form-control" id="formbrandmodel" name="formbrandmodel"/>
<label class="form-label" for="formbrandmodel">Brand Model</label>
</div>
</div>
<div class="col-lg-4 col-md-4">
<div class="form-outline mb-4">
<input type="text" class="form-control" id="formbrandprice" name="formbrandprice"/>
<label class="form-label" for="formbrandprice">Brand Price</label>
</div>
</div>
<div class="col-lg-4 col-md-4">
<div class="form-outline mb-4">
<input type="text" class="form-control" id="formavalability" name="formavalability"/>
<label class="form-label" for="formavalability">Avalability</label>
</div>
</div>
...
<td>
<a id="user_edit_action" href="javascript:void(0)" class="btn-small-01 bg-01 my-1 d-block" data-bs-toggle="modal" data-bs-target="#UserEdit" data-id="<?php  echo  $row['BrandID'] ?>">View &amp; Edit User</a>
<a id="user_delete_action" href="" class="btn-small-01 bg-02 my-1 d-block" data-id="<?php  echo  $row['BrandID'] ?>">Delete User</a>
...
//   };
  $(document).on("click", "#user_delete_action", function () {
    ...
    $.ajax({
        type: 'post',
        url: 'ajax-request.php',
        data: {'deleteScooterDetails':true,'Id':Idd},
...
var Id=$(this).data('id');
   ...
   $.ajax({
      type: 'post',
      url: 'ajax-request.php',
      data: {'getScooterDetails':true,'Id':Id},
