...
if(isset($_POST['submit'])){ 
    $sql="insert into tutorregistration (Name , Username , Password) values('".$_POST['formname']."','".$_POST["formusername"]."','".$_POST["formuserpassword"]."')";
...
if(isset($_POST['submitEdit'])){ 
	...
	$sql2="UPDATE tutorregistration SET Username= '".$_POST['formusereditname']."',Password= '".$_POST["formusereditpassword"]."',Name= '".$_POST["formeditname"]."' WHERE TutorID='".$_POST['formusereditid']."'";
	$conn2->query($sql2);
    $conn2->close();
}
...
<h1 class="title-page-name">Employees</h1>
</div>
</div>
</div>
</div>
...
<?php
    $sql= "SELECT * FROM tutorregistration ";
...
<td>
<a id="user_edit_action" href="javascript:void(0)" class="btn-small-01 bg-01 my-1 d-block" data-bs-toggle="modal" data-bs-target="#UserEdit" data-id="<?php  echo  $row['TutorID'] ?>">View &amp; Edit User</a>
<a id="user_delete_action" href="" class="btn-small-01 bg-02 my-1 d-block" data-id="<?php  echo  $row['TutorID'] ?>">Delete User</a>
...
<label class="form-label active" for="formeditname">Name</label>
</div>
</div>
</div>
</div>
...
var Id=$(this).data('id');
   ...
   $.ajax({
      ...
      success: function (data) {
        ...
        $(".modal-body #formeditname").val( obj[0].Name);
